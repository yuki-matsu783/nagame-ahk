...
[.claude/scripts/docs/spec/shell-scripts.md](../scripts/docs/spec/shell-scripts.md)「文字コード」節）。
...
[.claude/scripts/docs/spec/issue-mr-workflow.md](../scripts/docs/spec/issue-mr-workflow.md)
